...
BLEUUID Serv_SCALE("000078b2-0000-1000-8000-00805f9b34fb"); // the service

BLEUUID Char_person("00008a82-0000-1000-8000-00805f9b34fb"); // person data handle 22
BLEUUID Char_weight("00008a21-0000-1000-8000-00805f9b34fb"); // weight data handle 25
BLEUUID Char_body("00008a22-0000-1000-8000-00805f9b34fb");   // body data handle 28

BLEUUID Char_command("00008a81-0000-1000-8000-00805f9b34fb"); // command register handle 31
...
std::string timeAsString(time_t time)
{
  ...
  str << time;//tmYearToCalendar(tm.Year) << "-" << (int)tm.Month << "-" << (int)tm.Day << "-" << (int)tm.Hour << ":" << (int)tm.Minute << ":" << (int)tm.Second;
  return str.str();
}
